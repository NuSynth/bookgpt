...
# WRITING TEMPLATES
You need an API key for OpenAI. This is for if you want to write the chapters yourself.

# WRITING CHAPTERS
You need both an API key for Google Gemini and an API key for OpenAI.
